...
choice = input(
    "Use the number to select the correct language [1.English - 2.Spanish - 3.French :"
)
choice = int(choice)
...
if choice == 1:
    ...
    while game_is_active:
        ...
        while type(game_is_active) is not bool:
            ...
            if (
                game_is_active == "y"
                or game_is_active == "yes"
                or game_is_active == "oui"
                or game_is_active == "si"
            ):
                game_is_active = True
            elif (
                game_is_active == "n"
                or game_is_active == "no"
                or game_is_active == "non"
            ):
